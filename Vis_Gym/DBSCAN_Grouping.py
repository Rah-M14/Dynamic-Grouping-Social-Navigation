...
#     def __init__(self, grid_size=10, max_static_obstacles=30, max_dynamic_obstacles=20, max_steps=500):
        ...
        ''' To do: What would be the value in the matrix gridworld env'''
        self.boundary_threshold = 0.5
        
        '''no defined in my environment'''
        ...
        '''not defined in the matrix gridworld env'''
        ...
        '''These variables are from the matrix gridworld env'''
        ...
        '''the below function has been adapted for the matrix gridworld env'''
        self.dynamic_obstacles = self._init_dynamic_obstacles(obstacle_paths)
        
        '''values will be populated in the step function under collision if condition'''
        ...
        ''' To do: What would be the value in terms of my simulation grid world'''
        self.thresh = 1.5
...
#         self.agent_pos = np.clip(self.agent_pos, 0, self.grid_size - 0.5)
        ...
        for obstacle in self.dynamic_obstacles:
            if len(obstacle['path']) > 1:
                obstacle['current'] = obstacles_positions[str(i)]
#             else:
